...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  String _paceLabel({
    ...
    final timePct = daysElapsed / daysInMonth; // 0..1
    final spendPct = spentMinor / budgetMinor; // can exceed 1

    // tolerance: 7% of budget pacing
      ...
      body: BlocListener<ExportBloc, ExportState>(
        ...
        child: BlocBuilder<DashboardBloc, DashboardState>(
          builder: (context, state) {
            ...
            // Forecast (only meaningful for current month)
            ...
            // Alerts: categories that are projected to exceed limit
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (isCurrentMonth && alerts.isNotEmpty) ...[
                    const Text('Alerts (Projected Over Budget)',
